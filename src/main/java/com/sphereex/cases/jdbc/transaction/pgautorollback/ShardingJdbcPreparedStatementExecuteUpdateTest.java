...
@AutoTest
public final class ShardingJdbcPreparedStatementExecuteUpdateTest extends ShardingJdbcBaseTest {
    
    private  final Logger logger = LoggerFactory.getLogger(ShardingJdbcPreparedStatementExecuteUpdateTest.class);
    
    public ShardingJdbcPreparedStatementExecuteUpdateTest() throws Exception {
