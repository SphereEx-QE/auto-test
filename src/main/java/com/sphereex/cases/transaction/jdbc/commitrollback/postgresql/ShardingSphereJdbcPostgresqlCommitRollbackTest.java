package com.sphereex.cases.transaction.jdbc.commitrollback.postgresql;
...
@AutoTest
public final class ShardingSphereJdbcPostgresqlCommitRollbackTest extends ShardingJdbcCommitRollbackTest {
    ...
    @Override
    public void init() {
        String name = "ShardingSphereJdbcPostgresqlCommitRollbackTest";
