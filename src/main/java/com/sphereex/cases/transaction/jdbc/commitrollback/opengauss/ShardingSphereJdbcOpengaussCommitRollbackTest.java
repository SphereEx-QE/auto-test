package com.sphereex.cases.transaction.jdbc.commitrollback.opengauss;
...
@AutoTest
public final class ShardingSphereJdbcOpengaussCommitRollbackTest extends ShardingJdbcCommitRollbackTest {
    ...
    @Override
    public void init() {
        String name = "ShardingSphereJdbcOpengaussCommitRollbackTest";
