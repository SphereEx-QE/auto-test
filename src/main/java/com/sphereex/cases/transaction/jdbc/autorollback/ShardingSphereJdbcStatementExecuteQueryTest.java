...
public abstract class ShardingSphereJdbcStatementExecuteQueryTest extends ShardingSphereJdbcBaseTest {
    
    @Getter
    private final String yamlFile = null;
    
    private final Logger logger = LoggerFactory.getLogger(ShardingSphereJdbcStatementExecuteQueryTest.class);
