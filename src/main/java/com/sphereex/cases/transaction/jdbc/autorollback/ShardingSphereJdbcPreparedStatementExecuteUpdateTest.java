...
public abstract class ShardingSphereJdbcPreparedStatementExecuteUpdateTest extends ShardingSphereJdbcBaseTest {
    
    @Getter
    private final String yamlFile = null;
    
    private  final Logger logger = LoggerFactory.getLogger(ShardingSphereJdbcPreparedStatementExecuteUpdateTest.class);
