...
//@AutoTest
public abstract class ShardingSphereJdbcPreparedStatementExecuteQueryTest extends ShardingSphereJdbcBaseTest {
    
    @Getter
    private final String yamlFile = null;
    
    private  final Logger logger = LoggerFactory.getLogger(ShardingSphereJdbcPreparedStatementExecuteQueryTest.class);
