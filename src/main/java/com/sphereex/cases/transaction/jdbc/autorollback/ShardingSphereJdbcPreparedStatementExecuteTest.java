...
public abstract class ShardingSphereJdbcPreparedStatementExecuteTest extends ShardingSphereJdbcBaseTest {
    
    @Getter
    private final String yamlFile = null;
    
    private final Logger logger = LoggerFactory.getLogger(ShardingSphereJdbcPreparedStatementExecuteTest.class);
