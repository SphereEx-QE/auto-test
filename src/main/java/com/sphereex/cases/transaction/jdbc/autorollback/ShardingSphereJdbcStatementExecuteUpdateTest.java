...
public abstract class ShardingSphereJdbcStatementExecuteUpdateTest extends ShardingSphereJdbcBaseTest {
    
    @Getter
    private final String yamlFile = null;
    
    private static final Logger logger = LoggerFactory.getLogger(ShardingSphereJdbcStatementExecuteUpdateTest.class);
