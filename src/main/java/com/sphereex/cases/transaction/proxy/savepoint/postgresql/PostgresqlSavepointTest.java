package com.sphereex.cases.transaction.proxy.savepoint.postgresql;
...
@AutoTest
public final class PostgresqlSavepointTest extends ShardingSphereProxyBaseTest {
    
    private static final Logger logger = LoggerFactory.getLogger(PostgresqlSavepointTest.class);
