package com.sphereex.cases.transaction.proxy.commitrollback.postgresql;
...
@AutoTest
public final class ShardingSpherePostgresqlCommitRollbackTest extends ShardingCommitRollbackTest {
    ...
    @Override
    public void init() {
        String name = "ShardingSpherePostgresqlCommitRollbackTest";
        ...
        String configPath = "conf/case/transaction/proxy/commitrollback/postgresql";
