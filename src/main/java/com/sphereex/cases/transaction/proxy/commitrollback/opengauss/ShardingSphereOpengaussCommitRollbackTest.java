package com.sphereex.cases.transaction.proxy.commitrollback.opengauss;
...
@AutoTest
public final class ShardingSphereOpengaussCommitRollbackTest extends ShardingCommitRollbackTest {
    ...
    @Override
    public void init() {
        String name = "ShardingSphereOpengaussCommitRollbackTest";
        ...
        String configPath = "conf/case/transaction/proxy/commitrollback/opengauss";
