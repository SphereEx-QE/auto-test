package com.sphereex.cases.transaction.proxy.savepoint.mysql;
...
@AutoTest
public final class MySQLSavepointTest extends ShardingSphereProxyBaseTest {
    ...
    public void init() {
        ...
        String configPath = "conf/case/transaction/proxy/savepoint/mysql";
