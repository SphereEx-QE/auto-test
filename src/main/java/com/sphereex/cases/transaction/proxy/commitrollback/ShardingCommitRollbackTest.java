package com.sphereex.cases.transaction.proxy.commitrollback;
...
public abstract class ShardingCommitRollbackTest extends ShardingSphereProxyBaseTest {

    private static final Logger logger = LoggerFactory.getLogger(ShardingCommitRollbackTest.class);
