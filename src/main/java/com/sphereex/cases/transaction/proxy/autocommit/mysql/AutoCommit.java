package com.sphereex.cases.transaction.proxy.autocommit.mysql;
...
@AutoTest
public final class AutoCommit extends ShardingSphereProxyBaseTest {
    ...
    public void init() {
        ...
        String configPath = "conf/case/transaction/proxy/readonly/mysql";
